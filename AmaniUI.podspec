Pod::Spec.new do |s|
  ...
  s.source       = { :path => "." }
  s.resource_bundles = {
    'AmaniUI' => ['Sources/AmaniUI/**/*.{xib,storyboard,xcassets,xcprivacy}']
  }
  s.source_files = "Sources/AmaniUI/**/*.{h,m,swift}"
  s.exclude_files = [
    "AmaniUnitTests/**/*",
    "AmaniUI.xcodeproj/**/*"
  ]
  ...
  s.pod_target_xcconfig = {
    "OTHER_LDFLAGS" => "$(inherited) -weak_framework CryptoKit -weak_framework CoreNFC -weak_framework CryptoTokenKit"
  }
  s.dependency "lottie-ios", "~> 4.5.0"
  s.dependency "AmaniSDK", "~> 3.6.5"
  s.dependency "AmaniVoiceAssistantSDK", "~> 1.0"
end
